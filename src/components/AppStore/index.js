...
class AppStore extends Component {
  ...
  filterImagesList = searchResults => {
    const {activeTabId} = this.state
    const filterImagesList = searchResults.filter(
  ...
  render() {
    ...
    const filterImagesList = this.filterImagesList(searchResults)
    return (
      <div className="bg-container">
        <div className="content-container">
          ...
          <ul className="images-container">
            {filterImagesList.map(appDetails => (
